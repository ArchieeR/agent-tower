...
| [`03-programme/LINEAR-PROGRAMME-ORDER.md`](03-programme/LINEAR-PROGRAMME-ORDER.md) | Canonical Linear mirror | Stable initiative/project/milestone IDs, current five-stage order, dependency chain and same-change reconciliation rule. |
