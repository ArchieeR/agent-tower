...
capture_page("http://localhost:3008/organization", "rheos-org.png", 10)
capture_page("http://localhost:3008/connections", "rheos-connections.png", 20)
capture_page("http://localhost:3008/settings", "rheos-settings.png", 30)
