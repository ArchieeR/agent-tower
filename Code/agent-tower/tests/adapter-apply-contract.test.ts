...
const plan: AdapterPlanV1 = {
  ...
  capabilityMappingRevision: "mapping-rev-1", nativeDelta: { role: "builder" }, preflightAssertions: [], readbackAssertions: [{ field: "hostObjectRef", operator: "present" }],
